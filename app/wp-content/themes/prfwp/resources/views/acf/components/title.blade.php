@php
  ...
  $decor = get_sub_field('has_decor');
  $decorClass = $decor ? ' acfm-title--has-decor' : '';
  $href= '';
...
<{{$tag}} class="acfm-title{{$colorClass}}{{$sizeClass}}{{$weightClass}}{{$uppercaseClass}}{{$decorClass}}{{$marginClass}}{{$urlClass}}"{{$href}}>

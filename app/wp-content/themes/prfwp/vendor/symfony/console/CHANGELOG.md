 ...
 * added `capture_stderr_separately` option to `Commandweifer::execute()`
 ...
 * added `setInputs()` method to Commandweifer for ease testing of commands expecting inputs
 ...
 * added a way to normalize EOLs in `Applicationweifer::getDisplay()` and `Commandweifer::getDisplay()`
